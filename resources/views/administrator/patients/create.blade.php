...
@section('title', 'Agrega un paciente')
@section('content')
    <main>
        <form action="{{ route('patients.store') }}" method="POST" class="container">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="input-group mb-4 col-lg">
                        ...
                        <input type="text" name="first_last_name" id="first_last_name" class="form-control"
                            placeholder="Primero" value="{{ old('first_last_name') }}">
                        <input type="text" name="second_last_name" id="second_last_name" class="form-control"
                            placeholder="Segundo" value="{{ old('second_last_name') }}">
                ...
                <div class="row">
                    <div class="input-group mb-4 col-lg">
                        ...
                        <input type="text" name="document" id="document" class="form-control"
                            placeholder="Número de Documento" value="{{ old('document') }}">
                        @error('document')
                            *{{ $message }}
                        @enderror
                    </div>
